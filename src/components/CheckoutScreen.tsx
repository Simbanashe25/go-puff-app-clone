...
const styles = StyleSheet.create({
  ...
  header: { height: 64, paddingHorizontal: GOPUFF_SPACING.xl, backgroundColor: GOPUFF_COLORS.white, borderBottomWidth: StyleSheet.hairlineWidth, borderBottomColor: GOPUFF_COLORS.borderLight, flexDirection: 'row', alignItems: 'center' },
  backButton: { flexDirection: 'row', alignItems: 'center', gap: GOPUFF_SPACING.sm },
  backText: { fontFamily: GOPUFF_FONTS.black, fontSize: 14, fontWeight: '900', color: GOPUFF_COLORS.black },
  content: { padding: GOPUFF_SPACING.xl, paddingTop: GOPUFF_SPACING.lg, paddingBottom: GOPUFF_SPACING.xxl, maxWidth: 1400, width: '100%', alignSelf: 'center' },
  contentMobile: { padding: GOPUFF_SPACING.lg, paddingBottom: 100 },
  layout: { flexDirection: 'row', gap: GOPUFF_SPACING.xxl },
  layoutMobile: { flexDirection: 'column', gap: GOPUFF_SPACING.lg },
  formColumn: { flex: 1 },
  pageTitle: { fontFamily: GOPUFF_FONTS.black, fontSize: 42, fontWeight: '900', fontStyle: 'italic', color: GOPUFF_COLORS.black, marginBottom: GOPUFF_SPACING.xl },
  section: { backgroundColor: GOPUFF_COLORS.surface, borderRadius: GOPUFF_RADII.lg, padding: GOPUFF_SPACING.xl, marginBottom: GOPUFF_SPACING.lg, ...GOPUFF_SHADOWS.card },
  sectionTitle: { fontFamily: GOPUFF_FONTS.black, fontSize: 22, fontWeight: '900', fontStyle: 'italic', color: GOPUFF_COLORS.black, marginBottom: GOPUFF_SPACING.lg },
  ...
  input: { flex: 1, height: 66, minHeight: 66, maxHeight: 66, borderWidth: 1, borderColor: GOPUFF_COLORS.border, borderRadius: GOPUFF_RADII.sm, paddingHorizontal: GOPUFF_SPACING.md, paddingVertical: 0, marginBottom: GOPUFF_SPACING.md, fontFamily: GOPUFF_FONTS.regular, fontSize: 16, color: GOPUFF_COLORS.black, backgroundColor: GOPUFF_COLORS.white },
  ...
  summaryColumn: { width: 420, paddingTop: GOPUFF_SPACING.xl },
  summaryColumnMobile: { width: '100%', paddingTop: 0 },
  summaryCard: { backgroundColor: GOPUFF_COLORS.surface, borderRadius: GOPUFF_RADII.lg, padding: GOPUFF_SPACING.xl, ...GOPUFF_SHADOWS.card },
  summaryTitle: { fontFamily: GOPUFF_FONTS.black, fontSize: 24, fontWeight: '900', fontStyle: 'italic', color: GOPUFF_COLORS.black, marginBottom: GOPUFF_SPACING.lg },
  ...
  savingsCard: { backgroundColor: GOPUFF_COLORS.infoBackground, borderRadius: GOPUFF_RADII.lg, padding: GOPUFF_SPACING.lg, marginTop: GOPUFF_SPACING.xl },
  savingsTitle: { fontFamily: GOPUFF_FONTS.black, fontSize: 23, fontWeight: '900', fontStyle: 'italic', color: GOPUFF_COLORS.grayText },
