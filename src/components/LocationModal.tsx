...
const styles = StyleSheet.create({
  ...
  locationSelected: { backgroundColor: '#E2F4FD' },
  locationCopy: { flex: 1 },
  ...
  searchInput: { height: 68, borderWidth: 1, borderColor: '#00A3FF', borderRadius: 8, paddingHorizontal: 16, fontFamily: GOPUFF_FONTS.family, fontSize: 20 },
  detailsScreen: { paddingHorizontal: 22, paddingBottom: 22 },
  mapPlaceholder: { height: 130, backgroundColor: '#E3F1F7', alignItems: 'center', justifyContent: 'center' },
