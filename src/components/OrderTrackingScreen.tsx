...
const styles = StyleSheet.create({
  ...
  content: { width: '100%', maxWidth: 680, alignSelf: 'center', padding: GOPUFF_SPACING.xxl },
  ...
  title: { fontFamily: GOPUFF_FONTS.black, fontSize: 34, fontWeight: '900', fontStyle: 'italic', color: GOPUFF_COLORS.black, letterSpacing: -0.5 },
  orderNumber: { fontFamily: GOPUFF_FONTS.black, fontWeight: '900', color: GOPUFF_COLORS.action, marginTop: GOPUFF_SPACING.sm },
  hero: { backgroundColor: GOPUFF_COLORS.infoBackground, borderRadius: GOPUFF_RADII.lg, padding: GOPUFF_SPACING.xxl, alignItems: 'center', marginTop: GOPUFF_SPACING.xl, ...GOPUFF_SHADOWS.card },
  etaLabel: { fontFamily: GOPUFF_FONTS.black, fontSize: 14, fontWeight: '900', color: GOPUFF_COLORS.grayText },
  ...
  card: { backgroundColor: GOPUFF_COLORS.surface, borderRadius: GOPUFF_RADII.lg, padding: GOPUFF_SPACING.xl, marginTop: GOPUFF_SPACING.lg, ...GOPUFF_SHADOWS.card },
  ...
  stepCopy: { flex: 1 },
  stepTitle: { fontFamily: GOPUFF_FONTS.bold, fontSize: 16, fontWeight: '800', color: GOPUFF_COLORS.black },
  stepDetail: { fontFamily: GOPUFF_FONTS.regular, fontSize: 14, color: GOPUFF_COLORS.grayText, marginTop: 2 },
  supportButton: { height: 52, borderRadius: GOPUFF_RADII.pill, borderWidth: 2, borderColor: GOPUFF_COLORS.action, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: GOPUFF_SPACING.sm, marginTop: GOPUFF_SPACING.xl },
  supportText: { fontFamily: GOPUFF_FONTS.black, color: GOPUFF_COLORS.action, fontSize: 14, fontWeight: '900' },
});
